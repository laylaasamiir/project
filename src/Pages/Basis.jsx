...
const Basis = () => {
  ...
  return (
    <>
        ...
        <div className="container-fluid d-flex justify-content-between align-items-center">
          ...
          <div className="d-flex align-items-center gap-2" >
            <Link className='text-decoration-none' to={'/'}>
              <AiOutlineShoppingCart size={28} color="#3E5879" />
              <span style={{ fontWeight: "bold", fontSize: "20px", color: '#213555' }}>MyShop</span>
            </Link>
          </div>
          {/* Search */}
          <div className="d-flex align-items-center gap-3">
            <div className="navbar-search">
              ...
              >
                <AiOutlineSearch color="#3E5879" size={30} />
              </button>
              {isIconSeach && (
            ...
            <Link to={'/Cart'}>
              <div style={{ position: 'relative' }}>
                <button className='CartIcon'>
                  <AiFillShopping size={42} color="#3E5879" />
                  {totalCountV >= 0 && (
                    <span style={{
                      position: 'absolute',
                      fontSize: '18px',
      ...
      <button id="top-bt" className="btntop" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}><AiOutlineArrowUp color="#3E5879" /></button>
